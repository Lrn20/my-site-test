...
<!-- Next, ordered lists. Prefix each block below with a number and full stop ( 1. ) --> Does not have to be in order
...
Those are a few of the basics, but there is lots more to explore. [This is a great resource](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax) from GitHub.
